...
if __name__ == '__main__':
    ...
    build_improved_graph(features1, f_name = './data2/PCA_BRCA_v5/', type="BRCA_gene", threshold_mode="percentile", method='corr', threshold_pct=99)
    build_improved_graph(features2, f_name = './data2/PCA_BRCA_v5/', type="BRCA_methy", threshold_mode="percentile", method='corr', threshold_pct=99)
    build_improved_graph(features3, f_name = './data2/PCA_BRCA_v5/', type="BRCA_mirna", threshold_mode="percentile", method='corr', threshold_pct=99)