...
#     result_path = BASE_DIR / f"PCA_BRCA_results_{SEED}_contrastive.txt"
...
if __name__ == "__main__":
    for seed in SEEDS:
        ...
        path = BASE_DIR / "data2" / "PCA_BRCA_v5"

        cites1 = path / "edges_gene_brca_v5.csv"
        cites2 = path / "edges_methy_brca_v5.csv"
        cites3 = path / "edges_mirna_brca_v5.csv"
        ...
        result_path = BASE_DIR / f"BRCA_v5_results_{seed}_contrastive.txt"
        for fold, (train_mask, test_mask) in enumerate(kfold.split(mask)):
...
#         result_path = BASE_DIR / f"BRCA_5_labels_results_{seed}_contrastive.txt"
#         for fold, (train_mask, test_mask) in enumerate(kfold.split(mask)):
